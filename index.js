...
function sortByPricing(hotels, order) {
  return hotels.slice().sort((hotel1, hotel2) => {
...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  let sortedHotels = sortByPricing(hotels, pricing);
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  let sortedHotels = sortByRating(hotels, rating);
  res.json({ hotels: sortedHotels });
});
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  let sortedHotels = sortByReviews(hotels, reviews);
  res.json({ hotels: sortedHotels });
});
